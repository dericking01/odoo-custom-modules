...
class CashierReport(models.Model):
    ...
    line_ids = fields.One2many('cashier.report.line', 'report_id', string="Transactions")
    expenditure_ids = fields.One2many('cashier.expenditure', 'report_id', string="Expenditures")
